...
export const lookupMenuItemByBarcode = async (req: Request, res: Response) => {
    try {
        ...
        const result = await pool.query(
            `SELECT TOP 1 mi.*, mc.name as "categoryName", mc.name_ar as "categoryNameAr"
             FROM menu_items mi
...
export const lookupInventoryItemByBarcode = async (req: Request, res: Response) => {
    try {
        ...
        const result = await pool.query(
            `SELECT TOP 1 * FROM inventory_items WHERE barcode = $1`,
            [code]
        );
        ...
        const skuResult = await pool.query(
            `SELECT TOP 1 * FROM inventory_items WHERE sku = $1`,
            [code]
        );
...
export const unifiedBarcodeLookup = async (req: Request, res: Response) => {
    try {
        ...
        const menuResult = await pool.query(
            `SELECT TOP 1 mi.id, mi.name, mi.name_ar as "nameAr", mi.price, mi.barcode, mi.sku, 
        ...
        const invResult = await pool.query(
            `SELECT TOP 1 id, name, name_ar as "nameAr", barcode, sku, unit, category,
