...
const ROUTE_LABELS: Record<string, { en: string; ar: string }> = {
    ...
    '/inventory/items': { en: 'Stock Items', ar: 'الأصناف المخزنية' },
    '/inventory/suppliers': { en: 'Suppliers', ar: 'الموردين' },
    '/inventory/procurement': { en: 'Procurement', ar: 'المشتريات' },
    '/inventory/warehouses': { en: 'Warehouses & Transfers', ar: 'المخازن والتحويلات' },
    '/inventory/counts': { en: 'Stock Counts', ar: 'الجرد' },
    '/inventory/movements': { en: 'Movements & Withdrawals', ar: 'الحركات والمسحوبات' },
    ...
    '/butchery': { en: 'Butchery / Fabrication', ar: 'التشريح والتقطيع' },
