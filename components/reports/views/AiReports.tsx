   ...
   return (
      <>
               ...
               {activeCategory === 'AI' && activeSubReport === 'Price Elasticity Simulator' && (
                  <div className="space-y-6 animate-in slide-in-from-bottom-5 duration-150">
                     <div className="rounded-2xl border border-violet-500/25 bg-violet-500/10 px-4 py-3 text-xs font-bold text-violet-700 dark:text-violet-300">Hypothetical scenarios with fixed coefficients — not estimated demand curves. Use for what-if play, not pricing truth.</div>
